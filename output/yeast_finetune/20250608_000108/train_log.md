...
## before 评估时间：2025-06-08 00:01:11
- Pearson r: -0.0495
- P值: 8.33e-82
- Slope: -0.0017
- 样本数: 149688
...
- 真实均值: 4.1300
- 真实方差: 1.9793
- 结果可视化: output/yeast_finetune/20250608_000108/pred_vs_true_log1p_before.png

## after 评估时间：2025-06-08 00:03:06
- Pearson r: 0.1738
- P值: 0.00e+00
- Slope: 0.0403
- 样本数: 149688
...
- 真实均值: 4.1300
- 真实方差: 1.9793
- 结果可视化: output/yeast_finetune/20250608_000108/pred_vs_true_log1p_after.png

## 实验时间：2025-06-08 00:03:06
### 主要修改
- （请在此补充本次实验的主要修改点）
...
### 结果可视化
- Loss/LR曲线: output/yeast_finetune/20250608_000108/loss_lr_curve.png
- 预测vs真实值散点图 (log1p): output/yeast_finetune/20250608_000108/pred_vs_true_log1p_after.png
